      ...
      <div className="glass-card w-full max-w-md p-8 relative z-10">
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 p-3.5 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all text-sm font-bold text-white"
          >
